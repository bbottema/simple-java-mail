...
> **Implementation status:** Phases 1, 2 and 3 are complete and accepted. Phase 4's DSN work is also complete and accepted as of 17 September 2026: ENVID correlation (#736), shared DKIM/S/MIME Email configuration (#737), and recipient NOTIFY with automatic ORCPT (#738). Per-message REQUIRETLS (#741) is complete and accepted as well, bringing seven of the ten original steps to completion; the execution-view and configuration refinements are additional children, not extra original steps. These are unreleased 10.0.0 changes. Explicit SMTPUTF8/8BITMIME requirements, finalized SIZE handling, and the conformance suite remain proposals. Phase 4 and the parent plan are not complete. Benchmarking is not part of this work.

- Status: Phases 1, 2 and 3 complete and accepted; Phase 4 steps 6 and 7 complete and accepted; unreleased
...
| 7 | [#741](https://github.com/bbottema/simple-java-mail/issues/741) | Enhancement | 10.0.0 | - | Per-message REQUIRETLS (complete; unreleased) |
