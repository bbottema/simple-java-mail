...
- README, release entries, [ADR 0020](../../docs/adr/0020-dedicated-smtp-connection-diagnostics.md) and website Diagnostics explain usage and limits. The send infographic was reviewed and remains unchanged because this path is outside email sending.
