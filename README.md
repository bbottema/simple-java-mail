...
The current release is **9.3.1**.

[GitHub release](https://github.com/bbottema/simple-java-mail/releases/tag/9.3.1) · [Maven Central artifacts](https://repo1.maven.org/maven2/org/simplejavamail/simple-java-mail/9.3.1/) · [Migration guide](https://www.simplejavamail.org/migration-notes-9.2.0.html) · [Complete release history](RELEASE_HISTORY.md)
