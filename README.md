...
- Fixed CLI metadata generation for the expanded 9.0 builder API so generated help and options remain stable without exhausting heap during reflection compatibility checks.
