...
public class ServerConfigTest {
	...
	public void NoArgconstructor_WithoutConfigFile_WithoutHost() {
		...
		try {
			new ServerConfigImpl(null, null, null, null, null, null, null);
	...
	public void NoArgconstructor_WithoutConfigFile_WithoutPort() {
		ConfigLoaderTestHelper.clearConfigProperties();
		try {
			new ServerConfigImpl("host", null, null, null, null, null, null);
	...
	public void NoArgconstructor_WithoutConfigFile_MissingPasswordOrUsername() {
		ConfigLoaderTestHelper.clearConfigProperties();
		ServerConfig serverConfig = new ServerConfigImpl("host", 1234, "username", null, null, null, null);
		verifyServerConfig(serverConfig, "host", 1234, "username", null, null, null, null);

		try {
			new ServerConfigImpl("host", 1234, null, "password", null, null, null);
	...
	public void NoArgconstructor_WithoutConfigFile_Authenticated() {
		ConfigLoaderTestHelper.clearConfigProperties();
		ServerConfig serverConfig = new ServerConfigImpl("host", 1234, "username", "password", null, null, null);
		verifyServerConfig(serverConfig, "host", 1234, "username", "password", null, null, null);
	}

	@Test
	public void testToString() {
		ConfigLoaderTestHelper.clearConfigProperties();
		ServerConfig serverConfig = new ServerConfigImpl("host", 1234, null, null, null, null, null);
		assertThat(serverConfig.toString()).isEqualTo("host:1234");
		serverConfig = new ServerConfigImpl("host", 1234, "username", null, null, null, null);
		assertThat(serverConfig.toString()).isEqualTo("host:1234, username: username");
		serverConfig = new ServerConfigImpl("host", 1234, "username", "password", null, null, null);
		assertThat(serverConfig.toString()).isEqualTo("host:1234, username: username (authenticated)");
	}

	@SuppressWarnings("SameParameterValue")
	private void verifyServerConfig(ServerConfig serverConfig, @Nullable String host, @Nullable Integer port, @Nullable String username, @Nullable String password, @Nullable String oauth2Token, Object customSSLFactoryClass,
		...
		assertThat(serverConfig.getOAuth2Token()).isEqualTo(oauth2Token);
