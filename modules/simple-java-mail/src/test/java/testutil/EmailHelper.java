...
public class EmailHelper {
	...
	public static OperationalConfig createDummyOperationalConfig(@Nullable List<String> hostsToTrust, boolean trustAllSSLHost, boolean verifyServerIdentity) {
		return createDummyOperationalConfig(
				...
				/*18*/null,
				/*19*/false,
				/*20*/ofNullable(hostsToTrust).orElse(Lists.emptyList()),
				/*21*/trustAllSSLHost,
				/*22*/verifyServerIdentity,
	...
	public static OperationalConfig createDummyOperationalConfig(
			...
			/*13*/@Nullable final Integer connectionPoolExpireAfterCreationMillis,
			/*14*/@NotNull final LoadBalancingStrategy connectionPoolLoadBalancingStrategy,
			/*15*/@NotNull final Map<UUID, ConnectionPoolClusterConfig> connectionPoolClusterConfigs,
			/*16*/final boolean transportModeLoggingOnly,
			/*17*/final boolean debugLogging,
			/*18*/@Nullable final PrintStream debugPrinter,
			/*19*/final boolean disableAllClientValidation,
			/*20*/@NotNull final List<String> sslHostsToTrust,
			/*21*/final boolean trustAllSSLHost,
			/*22*/final boolean verifyingServerIdentity,
			/*23*/@NotNull final ExecutorService executorService,
			/*24*/final boolean isExecutorServiceUserProvided,
			/*25*/@Nullable final CustomMailer customMailer,
			/*26*/@Nullable final OAuth2AccessTokenProvider oauth2AccessTokenProvider) {
		try {
			...
			return (OperationalConfig) constructor.newInstance(
					...
					/*13*/connectionPoolExpireAfterCreationMillis,
