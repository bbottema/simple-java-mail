...
import static sockslib.utils.Util.checkNotNull;import static sockslib.utils.Util.checkNotNull;
...
public final class Arguments {
  ...
  public String argAt(int index,  String defaultValue){
  ...
  public String getValue(List<String> args,  String defaultValue) {
    checkNotNull(args);
  ...
  public String getValueFromArg(String prefix, String splitRegex,  String defaultValue) {
    checkNotNull(prefix);
