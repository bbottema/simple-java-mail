...
public class SocksSocket extends Socket {
	...
	private SocksSocket(SocksProxy proxy, String remoteServerHost, int remoteServerPort)
			throws IOException {
	 ...
	 */
	private SocksSocket(SocksProxy proxy, InetAddress address, int port)
			throws IOException {
	 ...
	 */
	private SocksSocket(SocksProxy proxy, Socket proxySocket) {
		checkNotNull(proxy, "Argument [proxy] may not be null");
