...
public final class EmailAddressParser {
     ...
     * <p>
     * This will do some smart unescaping to prevent that from happening unnecessarily; specifically, if there are unnecessary quotes around a personal name, it
