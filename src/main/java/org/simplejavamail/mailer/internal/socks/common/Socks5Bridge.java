 ...
 * proxy.
 * <p>
 * This Bridge connects the {@link AnonymousSocks5Server} server and the {@link Socks5} client.
 */
public interface Socks5Bridge {
	/**
	 * Generates a {@link Socket} using {@link Socks5} connected to authenticated proxy.
	 *
