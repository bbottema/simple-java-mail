...
public class EmailPopulatingBuilder {
	...
	/** Delegates to {@link #withRecipients(Collection, RecipientType)} with {@link RecipientType#TO}. */
	 public EmailPopulatingBuilder to								(@Nonnull final Recipient... recipients) { 										 					return withRecipients(asList(recipients), TO); }
	/** Delegates to {@link #withRecipients(Collection, RecipientType)} with {@link RecipientType#TO}. */
	 public EmailPopulatingBuilder to								(@Nonnull final Collection<Recipient> recipients) {  							 					return withRecipients(recipients, TO);  }
	/*
		TO: String
	 */
	/** Alias for {@link #toWithFixedName(String, String...)}. */
	 public EmailPopulatingBuilder to								(@Nullable final String name, String address) { 							 						return toWithFixedName(name, address); }
	/** Delegates to {@link #withRecipientsWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#TO} and empty default name. */
	 public EmailPopulatingBuilder to								(@Nonnull final String oneOrMoreAddresses) { 														return withRecipientsWithDefaultName(null, asList(oneOrMoreAddresses), TO); }
	/** Alias for {@link #toWithFixedName(String, String...)}. */
	 public EmailPopulatingBuilder to								(@Nullable final String name, @Nonnull final String... oneOrMoreAddressesEach) { 					return toWithFixedName(name, oneOrMoreAddressesEach); }
	/** Alias for {@link #toWithFixedName(String, Collection)}. */
	 public EmailPopulatingBuilder to								(@Nullable final String name, @Nonnull final Collection<String> oneOrMoreAddressesEach) { 			return toWithFixedName(name, oneOrMoreAddressesEach); }
	/** Delegates to {@link #withRecipientsWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#TO} and empty default name. */
	 public EmailPopulatingBuilder toMultiple						(@Nonnull final String... oneOrMoreAddressesEach) { 							 					return withRecipientsWithDefaultName(null, asList(oneOrMoreAddressesEach), TO); }
	/** Delegates to {@link #withRecipientsWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#TO} and empty default name. */
	 public EmailPopulatingBuilder toMultiple						(@Nonnull final Collection<String> oneOrMoreAddressesEach) { 							 			return withRecipientsWithDefaultName(null, oneOrMoreAddressesEach, TO); }
	/** Delegates to {@link #withRecipientsWithFixedName(String, Collection, RecipientType)} with {@link RecipientType#TO}. */
	 public EmailPopulatingBuilder toWithFixedName				(@Nullable final String name, @Nonnull final String... oneOrMoreAddressesEach) { 					return withRecipientsWithFixedName(name, asList(oneOrMoreAddressesEach), TO); }
	/** Delegates to {@link #withRecipientsWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#TO}. */
	 public EmailPopulatingBuilder toWithDefaultName				(@Nonnull final String name, @Nonnull final String... oneOrMoreAddressesEach) {	 					return withRecipientsWithDefaultName(name, asList(oneOrMoreAddressesEach), TO); }
	/** Delegates to {@link #withRecipientsWithFixedName(String, Collection, RecipientType)} with {@link RecipientType#TO}. */
	 public EmailPopulatingBuilder toWithFixedName				(@Nullable final String name, @Nonnull final Collection<String> oneOrMoreAddressesEach) { 			return withRecipientsWithFixedName(name, oneOrMoreAddressesEach, TO); }
	/** Delegates to {@link #withRecipientsWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#TO}. */
	 public EmailPopulatingBuilder toWithDefaultName				(@Nonnull final String name, @Nonnull final Collection<String> oneOrMoreAddressesEach) { 			return withRecipientsWithDefaultName(name, oneOrMoreAddressesEach, TO); }
	/*
		TO: InternetAddress
	 */
	/** Alias for {@link #toAddressesWithFixedName(String, InternetAddress...)}. */
	 public EmailPopulatingBuilder to								(@Nullable final String name, InternetAddress address) { 							 				return toAddressesWithFixedName(name, address); }
	/** Delegates to {@link #withAddressesWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#TO} and empty default name. */
	 public EmailPopulatingBuilder to								(@Nonnull final InternetAddress address) { 															return withAddressesWithDefaultName(null, asList(address), TO); }
	/** Alias for {@link #toAddressesWithFixedName(String, InternetAddress...)}. */
	 public EmailPopulatingBuilder to								(@Nullable final String name, @Nonnull final InternetAddress... oneOrMoreAddressesEach) { 			return toAddressesWithFixedName(name, oneOrMoreAddressesEach); }
	/** Alias for {@link #toAddressesWithFixedName(String, Collection)}. */
	 public EmailPopulatingBuilder toAddresses					(@Nullable final String name, @Nonnull final Collection<InternetAddress> oneOrMoreAddressesEach) { 	return toAddressesWithFixedName(name, oneOrMoreAddressesEach); }
	/** Delegates to {@link #withAddressesWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#TO} and empty default name. */
	 public EmailPopulatingBuilder toMultiple						(@Nonnull final InternetAddress... oneOrMoreAddressesEach) { 							 			return withAddressesWithDefaultName(null, asList(oneOrMoreAddressesEach), TO); }
	/** Delegates to {@link #withAddressesWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#TO} and empty default name. */
	 public EmailPopulatingBuilder toMultipleAddresses			(@Nonnull final Collection<InternetAddress> oneOrMoreAddressesEach) { 							 	return withAddressesWithDefaultName(null, oneOrMoreAddressesEach, TO); }
	/** Delegates to {@link #withAddressesWithFixedName(String, Collection, RecipientType)} with {@link RecipientType#TO}. */
	 public EmailPopulatingBuilder toAddressesWithFixedName		(@Nullable final String name, @Nonnull final InternetAddress... oneOrMoreAddressesEach) { 			return withAddressesWithFixedName(name, asList(oneOrMoreAddressesEach), TO); }
	/** Delegates to {@link #withAddressesWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#TO}. */
	 public EmailPopulatingBuilder toAddressesWithDefaultName		(@Nonnull final String name, @Nonnull final InternetAddress... oneOrMoreAddressesEach) {	 		return withAddressesWithDefaultName(name, asList(oneOrMoreAddressesEach), TO); }
	/** Delegates to {@link #withAddressesWithFixedName(String, Collection, RecipientType)} with {@link RecipientType#TO}. */
	 public EmailPopulatingBuilder toAddressesWithFixedName		(@Nullable final String name, @Nonnull final Collection<InternetAddress> oneOrMoreAddressesEach) { 	return withAddressesWithFixedName(name, oneOrMoreAddressesEach, TO); }
	/** Delegates to {@link #withAddressesWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#TO}. */
	 public EmailPopulatingBuilder toAddressesWithDefaultName		(@Nonnull final String name, @Nonnull final Collection<InternetAddress> oneOrMoreAddressesEach) { 	return withAddressesWithDefaultName(name, oneOrMoreAddressesEach, TO); }
	/*
		CC: Recipient
	 */
	/** Delegates to {@link #withRecipients(Collection, RecipientType)} with {@link RecipientType#CC}. */
	 public EmailPopulatingBuilder cc								(@Nonnull final Recipient... recipients) { 										 					return withRecipients(asList(recipients), CC); }
	/** Delegates to {@link #withRecipients(Collection, RecipientType)} with {@link RecipientType#CC}. */
	 public EmailPopulatingBuilder cc								(@Nonnull final Collection<Recipient> recipients) {  							 					return withRecipients(recipients, CC);  }
	/*
		CC: String
	 */
	/** Alias for {@link #ccWithFixedName(String, String...)}. */
	 public EmailPopulatingBuilder cc								(@Nullable final String name, String address) { 							 						return ccWithFixedName(name, address); }
	/** Delegates to {@link #withRecipientsWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#CC} and empty default name. */
	 public EmailPopulatingBuilder cc								(@Nonnull final String oneOrMoreAddresses) { 														return withRecipientsWithDefaultName(null, asList(oneOrMoreAddresses), CC); }
	/** Alias for {@link #ccWithFixedName(String, String...)}. */
	 public EmailPopulatingBuilder cc								(@Nullable final String name, @Nonnull final String... oneOrMoreAddressesEach) { 					return ccWithFixedName(name, oneOrMoreAddressesEach); }
	/** Alias for {@link #ccWithFixedName(String, Collection)}. */
	 public EmailPopulatingBuilder cc								(@Nullable final String name, @Nonnull final Collection<String> oneOrMoreAddressesEach) { 			return ccWithFixedName(name, oneOrMoreAddressesEach); }
	/** Delegates to {@link #withRecipientsWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#CC} and empty default name. */
	 public EmailPopulatingBuilder ccMultiple						(@Nonnull final String... oneOrMoreAddressesEach) { 							 					return withRecipientsWithDefaultName(null, asList(oneOrMoreAddressesEach), CC); }
	/** Delegates to {@link #withRecipientsWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#CC} and empty default name. */
	 public EmailPopulatingBuilder ccAddresses					(@Nonnull final Collection<String> oneOrMoreAddressesEach) { 							 			return withRecipientsWithDefaultName(null, oneOrMoreAddressesEach, CC); }
	/** Delegates to {@link #withRecipientsWithFixedName(String, Collection, RecipientType)} with {@link RecipientType#CC}. */
	 public EmailPopulatingBuilder ccWithFixedName				(@Nullable final String name, @Nonnull final String... oneOrMoreAddressesEach) { 					return withRecipientsWithFixedName(name, asList(oneOrMoreAddressesEach), CC); }
	/** Delegates to {@link #withRecipientsWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#CC}. */
	 public EmailPopulatingBuilder ccWithDefaultName				(@Nonnull final String name, @Nonnull final String... oneOrMoreAddressesEach) {	 					return withRecipientsWithDefaultName(name, asList(oneOrMoreAddressesEach), CC); }
	/** Delegates to {@link #withRecipientsWithFixedName(String, Collection, RecipientType)} with {@link RecipientType#CC}. */
	 public EmailPopulatingBuilder ccWithFixedName				(@Nullable final String name, @Nonnull final Collection<String> oneOrMoreAddressesEach) { 			return withRecipientsWithFixedName(name, oneOrMoreAddressesEach, CC); }
	/** Delegates to {@link #withRecipientsWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#CC}. */
	 public EmailPopulatingBuilder ccWithDefaultName				(@Nonnull final String name, @Nonnull final Collection<String> oneOrMoreAddressesEach) { 			return withRecipientsWithDefaultName(name, oneOrMoreAddressesEach, CC); }
	/*
		CC: InternetAddress
	 */
	/** Alias for {@link #ccAddressesWithFixedName(String, InternetAddress...)}. */
	 public EmailPopulatingBuilder cc								(@Nullable final String name, InternetAddress address) { 							 				return ccAddressesWithFixedName(name, address); }
	/** Delegates to {@link #withAddressesWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#CC} and empty default name. */
	 public EmailPopulatingBuilder cc								(@Nonnull final InternetAddress address) { 															return withAddressesWithDefaultName(null, asList(address), CC); }
	/** Alias for {@link #ccAddressesWithFixedName(String, InternetAddress...)}. */
	 public EmailPopulatingBuilder cc								(@Nullable final String name, @Nonnull final InternetAddress... oneOrMoreAddressesEach) { 			return ccAddressesWithFixedName(name, oneOrMoreAddressesEach); }
	/** Alias for {@link #ccAddressesWithFixedName(String, Collection)}. */
	 public EmailPopulatingBuilder ccAddresses					(@Nullable final String name, @Nonnull final Collection<InternetAddress> oneOrMoreAddressesEach) { 	return ccAddressesWithFixedName(name, oneOrMoreAddressesEach); }
	/** Delegates to {@link #withAddressesWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#CC} and empty default name. */
	 public EmailPopulatingBuilder ccMultiple						(@Nonnull final InternetAddress... oneOrMoreAddressesEach) { 							 			return withAddressesWithDefaultName(null, asList(oneOrMoreAddressesEach), CC); }
	/** Delegates to {@link #withAddressesWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#CC} and empty default name. */
	 public EmailPopulatingBuilder ccMultipleAddresses			(@Nonnull final Collection<InternetAddress> oneOrMoreAddressesEach) { 							 	return withAddressesWithDefaultName(null, oneOrMoreAddressesEach, CC); }
	/** Delegates to {@link #withAddressesWithFixedName(String, Collection, RecipientType)} with {@link RecipientType#CC}. */
	 public EmailPopulatingBuilder ccAddressesWithFixedName		(@Nullable final String name, @Nonnull final InternetAddress... oneOrMoreAddressesEach) { 			return withAddressesWithFixedName(name, asList(oneOrMoreAddressesEach), CC); }
	/** Delegates to {@link #withAddressesWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#CC}. */
	 public EmailPopulatingBuilder ccAddressesWithDefaultName		(@Nonnull final String name, @Nonnull final InternetAddress... oneOrMoreAddressesEach) {	 		return withAddressesWithDefaultName(name, asList(oneOrMoreAddressesEach), CC); }
	/** Delegates to {@link #withAddressesWithFixedName(String, Collection, RecipientType)} with {@link RecipientType#CC}. */
	 public EmailPopulatingBuilder ccAddressesWithFixedName		(@Nullable final String name, @Nonnull final Collection<InternetAddress> oneOrMoreAddressesEach) { 	return withAddressesWithFixedName(name, oneOrMoreAddressesEach, CC); }
	/** Delegates to {@link #withAddressesWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#CC}. */
	 public EmailPopulatingBuilder ccAddressesWithDefaultName		(@Nonnull final String name, @Nonnull final Collection<InternetAddress> oneOrMoreAddressesEach) { 	return withAddressesWithDefaultName(name, oneOrMoreAddressesEach, CC); }
	/*
		BCC: Recipient
	 */
	/**
	...
	/** Alias for {@link #bccAddressesWithFixedName(String, InternetAddress...)}. */
	 public EmailPopulatingBuilder bcc							(@Nullable final String name, InternetAddress address) { 							 				return bccAddressesWithFixedName(name, address); }
	/** Delegates to {@link #withAddressesWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#BCC} and empty default name. */
	 public EmailPopulatingBuilder bcc							(@Nonnull final InternetAddress address) { 															return withAddressesWithDefaultName(null, asList(address), BCC); }
	/** Alias for {@link #bccAddressesWithFixedName(String, InternetAddress...)}. */
	 public EmailPopulatingBuilder bcc							(@Nullable final String name, @Nonnull final InternetAddress... oneOrMoreAddressesEach) { 			return bccAddressesWithFixedName(name, oneOrMoreAddressesEach); }
	/** Alias for {@link #bccAddressesWithFixedName(String, Collection)}. */
	 public EmailPopulatingBuilder bccAddresses					(@Nullable final String name, @Nonnull final Collection<InternetAddress> oneOrMoreAddressesEach) { 	return bccAddressesWithFixedName(name, oneOrMoreAddressesEach); }
	/** Delegates to {@link #withAddressesWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#BCC} and empty default name. */
	 public EmailPopulatingBuilder bccMultiple					(@Nonnull final InternetAddress... oneOrMoreAddressesEach) { 							 			return withAddressesWithDefaultName(null, asList(oneOrMoreAddressesEach), BCC); }
	/** Delegates to {@link #withAddressesWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#BCC} and empty default name. */
	 public EmailPopulatingBuilder bccMultipleAddresses			(@Nonnull final Collection<InternetAddress> oneOrMoreAddressesEach) { 							 	return withAddressesWithDefaultName(null, oneOrMoreAddressesEach, BCC); }
	/** Delegates to {@link #withAddressesWithFixedName(String, Collection, RecipientType)} with {@link RecipientType#BCC}. */
	 public EmailPopulatingBuilder bccAddressesWithFixedName		(@Nullable final String name, @Nonnull final InternetAddress... oneOrMoreAddressesEach) { 			return withAddressesWithFixedName(name, asList(oneOrMoreAddressesEach), BCC); }
	/** Delegates to {@link #withAddressesWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#BCC}. */
	 public EmailPopulatingBuilder bccAddressesWithDefaultName	(@Nonnull final String name, @Nonnull final InternetAddress... oneOrMoreAddressesEach) {	 		return withAddressesWithDefaultName(name, asList(oneOrMoreAddressesEach), BCC); }
	/** Delegates to {@link #withAddressesWithFixedName(String, Collection, RecipientType)} with {@link RecipientType#BCC}. */
	 public EmailPopulatingBuilder bccAddressesWithFixedName		(@Nullable final String name, @Nonnull final Collection<InternetAddress> oneOrMoreAddressesEach) { 	return withAddressesWithFixedName(name, oneOrMoreAddressesEach, BCC); }
	/** Delegates to {@link #withAddressesWithDefaultName(String, Collection, RecipientType)} with {@link RecipientType#BCC}. */
	 public EmailPopulatingBuilder bccAddressesWithDefaultName	(@Nonnull final String name, @Nonnull final Collection<InternetAddress> oneOrMoreAddressesEach) { 	return withAddressesWithDefaultName(name, oneOrMoreAddressesEach, BCC); }
	// @formatter:on
