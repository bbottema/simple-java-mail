...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(7);
var maven_dependency_display_component_1 = __webpack_require__(107);
...
Download = __decorate([
    core_1.Component({
        ...
        entryComponents: [maven_dependency_display_component_1.MavenDependencyDisplay]
    })
], Download);
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(7);
var maven_search_service_1 = __webpack_require__(185);
var sprintf = __webpack_require__(67).sprintf;
var MavenDependencyDisplay = MavenDependencyDisplay_1 = (function () {
    function MavenDependencyDisplay(mavenSearchService) {
        this.mavenSearchService = mavenSearchService;
    }
    MavenDependencyDisplay.prototype.ngOnInit = function () {
        var _this = this;
        this.output = sprintf(MavenDependencyDisplay_1.DISPLAY_TEMPLATE, this.groupId, this.artifact, '...');
        this.mavenSearchService.fetchLatestVersion(this.groupId, this.artifact)
            .subscribe(function (latestVersion) {
            return _this.output = sprintf(MavenDependencyDisplay_1.DISPLAY_TEMPLATE, _this.groupId, _this.artifact, latestVersion);
        });
    };
    return MavenDependencyDisplay;
}());
MavenDependencyDisplay.DISPLAY_TEMPLATE = '<pre><code class="language-markup">&lt;dependency&gt;\n' +
    '\t&lt;groupId&gt;%s&lt;/groupId&gt;\n' +
...
], MavenDependencyDisplay.prototype, "groupId", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", String)
], MavenDependencyDisplay.prototype, "artifact", void 0);
MavenDependencyDisplay = MavenDependencyDisplay_1 = __decorate([
    core_1.Component({
        selector: 'maven-dependency-display',
        template: __webpack_require__(341),
        providers: [maven_search_service_1.MavenSearchService]
    }),
    __metadata("design:paramtypes", [maven_search_service_1.MavenSearchService])
], MavenDependencyDisplay);
exports.MavenDependencyDisplay = MavenDependencyDisplay;
var MavenDependencyDisplay_1;
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(7);
var RfcCompliant = (function () {
    function RfcCompliant() {
    }
    return RfcCompliant;
}());
RfcCompliant = __decorate([
    core_1.Component({
        template: __webpack_require__(342)
    })
], RfcCompliant);
exports.RfcCompliant = RfcCompliant;
...
var simple_java_mail_routes_1 = __webpack_require__(187);
var simple_java_mail_app_1 = __webpack_require__(186);
var platform_browser_1 = __webpack_require__(40);
var http_1 = __webpack_require__(65);
var ng2_simple_page_scroll_1 = __webpack_require__(66);
var about_1 = __webpack_require__(101);
var features_1 = __webpack_require__(106);
var configuration_1 = __webpack_require__(102);
var debugging_1 = __webpack_require__(104);
var rfc_1 = __webpack_require__(108);
var download_1 = __webpack_require__(105);
var contact_1 = __webpack_require__(103);
var maven_dependency_display_component_1 = __webpack_require__(107);
// enableProdMode();
...
AppModule = __decorate([
    core_1.NgModule({
        declarations: [
            simple_java_mail_app_1.SimpleJavaMailApp,
            about_1.About,
            features_1.Features,
            configuration_1.Configuration,
            debugging_1.Debugging,
            rfc_1.RfcCompliant,
            download_1.Download,
            contact_1.Contact,
            maven_dependency_display_component_1.MavenDependencyDisplay
        ],
        imports: [
            platform_browser_1.BrowserModule,
            http_1.HttpModule,
            router_1.RouterModule.forRoot(simple_java_mail_routes_1.rootRouterConfig, { useHash: true }),
            ng2_simple_page_scroll_1.Ng2SimplePageScrollModule.forRoot()
        ],
        bootstrap: [simple_java_mail_app_1.SimpleJavaMailApp]
    })
], AppModule);
...
var sprintf = __webpack_require__(67).sprintf;
var MavenSearchService = MavenSearchService_1 = (function () {
    function MavenSearchService(http) {
        this.http = http;
        this.latestVersion = new Subject_1.Subject();
    }
    MavenSearchService.prototype.fetchLatestVersion = function (groupId, artifact) {
        var _this = this;
        this.http
            .get(sprintf(MavenSearchService_1.endpoint, groupId, artifact))
            .map(function (res) { return res.json().value.replace('v', ''); })
            .subscribe(function (latestVersion) { return _this.latestVersion.next(latestVersion); });
        return this.latestVersion;
    };
    return MavenSearchService;
}());
MavenSearchService.endpoint = 'https://img.shields.io/maven-central/v/%s/%s.json';
MavenSearchService = MavenSearchService_1 = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http])
], MavenSearchService);
exports.MavenSearchService = MavenSearchService;
var MavenSearchService_1;
...
var SimpleJavaMailApp = (function () {
    // router is used by the template (#navigation)
    function SimpleJavaMailApp(router, el) {
        this.router = router;
        this.el = el;
        ng2_simple_page_scroll_1.SimplePageScrollConfig.defaultScrollOffset = 0;
    }
    // scrollToTop is used by the template
    SimpleJavaMailApp.prototype.scrollToTop = function () {
        this.el.nativeElement.ownerDocument.body.scrollTop = 0;
    };
    SimpleJavaMailApp.prototype.ngAfterViewChecked = function () {
        return Prism.highlightAll();
    };
    return SimpleJavaMailApp;
}());
SimpleJavaMailApp = __decorate([
    core_1.Component({
...
exports.SimpleJavaMailApp = SimpleJavaMailApp;
...
exports.rootRouterConfig = [
    ...
    { path: 'configuration', component: configuration_1.Configuration },
    { path: 'debugging', component: debugging_1.Debugging },
    { path: 'rfc', component: rfc_1.RfcCompliant },
    { path: 'download', component: download_1.Download },
...
var app_1 = __webpack_require__(163);
exports.platformRef = platform_browser_dynamic_1.platformBrowserDynamic();
function main() {
    return exports.platformRef.bootstrapModule(app_1.AppModule)
...
module.exports = "data:image/png;base64,"
