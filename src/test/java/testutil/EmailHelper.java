...
public class EmailHelper {
	...
	public static EmailPopulatingBuilder createDummyEmailBuilder(final boolean includeSubjectAndBody, final boolean basicFields, final boolean includeCustomHeaders) throws IOException {
		return createDummyEmailBuilder(null, includeSubjectAndBody, basicFields, includeCustomHeaders);
	}
	
	public static EmailPopulatingBuilder createDummyEmailBuilder(@Nullable final String id, final boolean includeSubjectAndBody, final boolean basicFields, final boolean includeCustomHeaders)
			throws IOException {
	...
	public static EmailPopulatingBuilder readOutlookMessage(final String filePath) {
		final InputStream resourceAsStream = EmailHelper.class.getClassLoader().getResourceAsStream(filePath);
