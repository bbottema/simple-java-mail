...
public class MimeMessageHelperTest {
	...
	public void determineResourceName1()
			throws IOException {
		final AttachmentResource resource1 = new AttachmentResource(null, getDataSource("blahblah"));
	...
	public void determineResourceName2()
			throws IOException {
		final AttachmentResource resource2 = new AttachmentResource(null, getDataSource("blahblah.txt"));
	...
	public void determineResourceName3()
			throws IOException {
		final AttachmentResource resource3 = new AttachmentResource("the resource", getDataSource(null));
	...
	public void determineResourceName4()
			throws IOException {
		final AttachmentResource resource4 = new AttachmentResource("the resource", getDataSource("blahblah.txt"));
	...
	public void determineResourceName5()
			throws IOException {
		final AttachmentResource resource5 = new AttachmentResource("the resource", getDataSource("blahblah"));
	...
	public void determineResourceName6()
			throws IOException {
		final AttachmentResource resource6 = new AttachmentResource("the resource.txt", getDataSource("blahblah.txt"));
	...
	public void determineResourceName7()
			throws IOException {
		final AttachmentResource resource7 = new AttachmentResource("the resource.txt", getDataSource("blahblah"));
	...
	private ByteArrayDataSource getDataSource(final String name)
			throws IOException {
		final ByteArrayDataSource ds = new ByteArrayDataSource("", "text/text");
		ds.setName(name);
		return ds;
	}
