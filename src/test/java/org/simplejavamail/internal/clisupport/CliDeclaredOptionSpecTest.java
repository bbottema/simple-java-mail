...
public class CliDeclaredOptionSpecTest {
	...
	private CliDeclaredOptionSpec createDummyCommand(List<CliDeclaredOptionSpec> unsortedSet, String prefix, String name) {
		...
		CliDeclaredOptionSpec instance = new CliDeclaredOptionSpec(prefix + ":" + name, new ArrayList<String>(), new ArrayList<CliDeclaredOptionValue>(), EMAIL, new ArrayList<CliCommandType>(), dummyMethod);
