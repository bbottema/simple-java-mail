...
public class MailTestDemoApp {
	...
	private static final Mailer buildMailer(final String host, final int port, final String gMailAddress, final String gMailPassword, final TransportStrategy strategy) {
